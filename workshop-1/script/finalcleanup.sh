...
ROLE='eksctl-mythicalmysfits-nodegroup-NodeInstanceRole-1TLRKSZC5S36X'
...
kubectl delete -f /sydummit-eksworkshop-2019/Kubernetes/mono/monolith-app.yaml
kubectl delete -f /sydummit-eksworkshop-2019/Kubernetes/micro/likeservice-app.yaml
kubectl delete -f /sydummit-eksworkshop-2019/Kubernetes/micro/nolikeservice-app.yaml
kubectl delete -f /sydummit-eksworkshop-2019/Kubernetes/micro/mythical-ingress.yaml
kubectl delete -f /sydummit-eksworkshop-2019/Kubernetes/micro/alb-ingress-controller.yaml
...
aws iam delete-role-policy --role-name $ROLE --policy-name ingress-db

aws eks delete-cluster --name mythicalmysfits
